...
@section('title', 'Campaign Marketplace VOBI — Katalog Kreator & Performa')
...
@section('og_title', 'Campaign Marketplace — Katalog Kreator VOBI')
...
<script type="application/ld+json">@php
    echo json_encode([
        ...
        'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 2, 'name' => 'Campaign Marketplace', 'item' => url()->current()],
        ],
...
<section class="mk-hero">
  <div class="wrap">
    <nav class="crumb" aria-label="Breadcrumb"><a href="{{ route('home') }}">Beranda</a><span class="sep">/</span><span>Campaign Marketplace</span></nav>
    <span class="eyebrow">Unggulan</span>
    <h1 class="disp">Pilih kreator, <span class="flame">lihat performa</span>, ajak kerjasama.</h1>
    <p class="lead2">Katalog kreator terverifikasi VOBI — lengkap dengan tier, harga, SOW, dan performa 3 bulan terakhir. Semua data di-input &amp; dijaga tim kami.</p>
  </div>
</section>
...
<section style="border-top:1px solid var(--line-2)">
  <div class="wrap">
    <div class="sec-head rv">
      <div><span class="eyebrow">Paket Campaign</span><h2 class="disp">Siap jalan.</h2></div>
    </div>
